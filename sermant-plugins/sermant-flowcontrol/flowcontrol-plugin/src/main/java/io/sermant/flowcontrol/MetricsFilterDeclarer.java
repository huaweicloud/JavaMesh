 ...
 * @since 2025-02-27
 */
public class MetricsFilterDeclarer extends DubboDeclarer {
    private static final String ENHANCE_CLASS = "org.apache.dubbo.metrics.filter.MetricsFilter";
